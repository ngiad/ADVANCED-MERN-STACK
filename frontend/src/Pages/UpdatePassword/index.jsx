...
const UpdatePassword = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await Requestbase.post("api/users/updatepassword", {
        ...UpdataPassword,
        token,
      });
      ...
      <div className="fromlogin">
        ...
        <div className="login">
          <form onSubmit={handleSubmit}>
            ...
            />
            <input
              value={UpdataPassword.confirmPassword}
              onChange={(e) =>
                setUpdatePassword({
                  ...UpdataPassword,
