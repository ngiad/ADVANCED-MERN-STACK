...
const EditAccount = ({handleCheckEdit}) => {
    ...
    const HandleSubmit = async(e) => {
        ...
        if(!FileAvatar){
            try {
                const res = await Requestbase.post("api/users/updateprofile",EditProfile,{
                    headers :{
                        token : User.token
                    }
                })
        ...
        try {
            ...
            const res = await Requestbase.post("api/users/updateprofile",{...EditProfile,photo : Url.data.img},{
                headers :{
                    token : User.token
                }
            })
    ...
    <div className='EditAccount shadow-drop-center'>
        ...
        <div className='EditAccountContener'>
            <form onSubmit={HandleSubmit}>
                ...
                <input onChange={handleChangeInput} id="name" value={EditProfile.name} type="text" />
                <label htmlFor="">Email Profile</label>
                <input onChange={handleChangeInput} id="email" value={EditProfile.email} type="text" />
                <label htmlFor="">Phone Profile</label>
                <input onChange={handleChangeInput} id="phone" value={EditProfile.phone} type="text" />
                <label htmlFor="">Bio Profile</label>
                <input onChange={handleChangeInput} id="bio" value={EditProfile.bio} type="text" />
            </form>
